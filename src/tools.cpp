...
/**
* Parse vaizon address in a string form into
...
/**
* Return string representation of vaizon address
*/
string
...
{
    // default path to vaizon folder
    // on linux this is /home/<username>/.vaizon
    string default_vaizon_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_vaizon_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_vaizon_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_vaizon_dir + string("/lmdb");
}
