var config = {
    ...
    coinUnitPlaces: 9,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Vaizon
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Vaizon
    coinSymbol: 'VZN',
    openAliasPrefix: "vzn",
    coinName: 'Vaizon',
    coinUriPrefix: 'vaizon:',
    addressPrefix: 114,
